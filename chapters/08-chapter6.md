...
| Categorical ordered aka ordinal | Numbering - assign numbers in ascending or descending order. For example, if an alert has low, medium, and high levels, the corresponding encoding maybe 0, 1, or 2 to indicate the order of criticality. | Same as unordered categorical. |
<p align="center">
